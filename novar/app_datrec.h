...
#ifndef _APP_DATREC_H
#define _APP_DATREC_H
...
/*
	...
	K9F1G08U0D		= 0xEC 0xF1 0x00 0x15 0x40
    K9F1G08U0F		= 0xEC 0xF1 0x00 0x95 0x42
*/
...
#define K9F1G08U0D		0xECF10015
#define K9F1G08U0F		0xECF10095
...
/*用于HY27UF081G2A    K9F1G08 */
	...
	#define NAND_BLOCK_SIZE            ((uint16_t)0x0040) /*64 x 2048 bytes pages per block */
	#define NAND_ZONE_SIZE             ((uint16_t)0x0400) /*1024 Block per zone */
	#define NAND_SPARE_AREA_SIZE       ((uint16_t)0x0040) /*last 64 bytes as spare area */
	#define NAND_MAX_ZONE              ((uint16_t)0x0001) /*1 zones of 1024 block */
#endif
...
#define MAX_FRAME_DAT 1024*64*8		// 实时数据最大帧数
#define DATREC_FRAME_SIZE 256			// 单帧长度
/*Private Structures---------------------------------------------------------*/
